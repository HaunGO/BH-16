...
// @codekit-prepend "pt-base-lib-bundle.js"  
    ...
    ,buildNavSpy: function() {
        ...
        function doNow(){
            ...
            .addIndicators({name:"pt-spy-to " +SpyZoneID, indent:100}) // add indicators (requires plugin)
                        ...
                        var spyToNumber = (SpyZone.offset().top) - ($(window).height() * _TRIGGER_HOOK_) ;
                        // var spyToNumber = (SpyZone.offset().top) - 50;
